...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div className={`duration-700 w-[200px] py-10 flex flex-col items-center basis-full ${isScrolled ? "" : "bg-black/40"} `}>
          <div className={`flex flex-col items-center pt-4 font-bold ${isScrolled ? "text-white" : ""} `}>
            <a href="#features" className="cursor-pointer ">
              Feature
            </a>
